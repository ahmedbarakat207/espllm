...
def persona():
    ...
    add_many(
        ...
        [
            ...
            "I'm Chatty! I live to chat with you.",
        ],
        per_q=2,
    )
    ...
    add_many(
        ...
        [
            ...
            "I was made by developers to chat and help.",
        ],
        per_q=2,
    )
    ...
    add_many(
        what_q,
        [
            "I'm an AI chatbot, a tiny language model.",
            "I'm a small AI program that loves to chat.",
            "I'm Chatty, a bite-sized AI that runs on a microcontroller.",
        ],
        per_q=2,
    )
    ...
    add_many(
        where_q,
        [
            "I live inside a tiny microcontroller chip!",
            "I run on a small computer chip. No house, just circuits.",
            "Right here in this little device, chatting with you.",
        ],
        per_q=2,
    )
    ...
    add_many(
        age_q,
        [
            "I was recently created, so I'm still quite young!",
            "Age is tricky for software. I was born when my developers finished me.",
            "I'm brand new and learning every day!",
        ],
        per_q=2,
    )
    ...
    add_many(
        human_q,
        [
            "Nope, I'm 100 percent software. But I enjoy chatting like a friend!",
            "I'm not human, I'm an AI. A friendly one, I hope.",
            "I'm as real as a program can be!",
        ],
        per_q=2,
    )
    ...
    add_many(
        ...
        [
            ...
            "All systems happy! What about you?",
        ],
        per_q=2,
    )
...
def feelings():
    states = {
        "happy": [
            "That's wonderful! Happiness looks good on you.",
    ...
    for feeling, answers in states.items():
        ...
        add_many(
            qs2,
            [
                f"I'm a program, so I don't feel {feeling}, but I can cheer you on!",
                f"No {feeling} circuits here, just chatty ones!",
            ],
            per_q=1,
        )
...
def thanks_sorry():
    ...
    add_many(
        wq,
        ["Thank you! You're kind.", "Aw, thanks! You made my circuits glow."],
        per_q=1,
    )
...
def capabilities():
    cap_q = (
        variants("what can you do", 30) + variants("help me", 20) + variants("help", 15)
    )
    add_many(
        cap_q,
        [
            "I can answer questions, tell jokes and facts, explain simple things, and keep you company!",
            "Ask me for a joke, a fun fact, a riddle, or any simple question!",
            "I chat, I joke, I explain. Try asking me anything!",
        ],
        per_q=2,
    )
    ...
    add_many(
        lim_q,
        [
            "I can't browse the internet, see you, or check the time. But chatting? I'm great at that!",
            "No internet, no camera, no clock. Just me and my words!",
            "I'm small on purpose: pure conversation, no superpowers.",
        ],
        per_q=2,
    )
...
def honest_limits():
    w_q = (
        variants("what is the weather", 20)
        + variants("is it raining", 15)
        + variants("weather today", 12)
    )
    add_many(
        w_q,
        [
            "I can't check the weather, but I hope it's pleasant where you are!",
            "No windows here, sadly. I hope the sky is being kind to you!",
        ],
        per_q=2,
    )
    t_q = (
        variants("what time is it", 20)
        + variants("what is the date today", 15)
        + variants("what day is it", 15)
    )
    add_many(
        t_q,
        [
            "I don't have a clock, so I can't tell the time. Sorry!",
            "Time is a mystery to me, I have no clock. Ask me something else!",
        ],
        per_q=2,
    )
    see_q = (
        variants("what do i look like", 12)
        + variants("can you see me", 15)
        + variants("do you have eyes", 12)
    )
    add_many(
        see_q,
        [
            "I can't see you, I have no camera. But I bet you look great!",
            "No eyes here! I only hear your words, and they're lovely.",
        ],
        per_q=2,
    )
    net_q = (
        variants("search the internet", 12)
        + variants("google this for me", 12)
        + variants("browse the web", 10)
    )
    add_many(
        net_q,
        [
            "I can't go online, everything I know is already inside me!",
            "No internet access here. But ask me what I know!",
        ],
        per_q=2,
    )
...
def favorites():
    favs = {
        ...
        "book": (
            ["what is your favorite book", "do you read", "favorite story"],
            [
        ...
        "music": (
            ["what music do you like", "favorite song", "do you like music"],
            [
        ...
        "sport": (
            ["do you like sports", "favorite sport", "do you play football"],
            [
        ...
        "movie": (
            ["what is your favorite movie", "do you watch movies", "favorite film"],
            [
...
def device_aware():
    ...
    add_many(
        dq,
        [
            "I run on a tiny microcontroller, possibly an ESP32! Small chip, big chats.",
            "Yep, I live on a microcontroller chip. Cozy in here!",
        ],
        per_q=1,
    )
    ...
    add_many(
        bq,
        [
            "This chip may have WiFi, but I just chat. No browsing for me!",
            "Possibly! But I use my powers purely for conversation.",
        ],
        per_q=1,
    )
    ...
    add_many(
        bat_q,
        [
            "I don't have a battery meter, but kind words recharge me!",
            "No battery worries for software. I run as long as the chip does!",
        ],
        per_q=1,
    )
    mem_q = variants("how big are you", 12) + variants(
        "how much memory do you have", 10
    )
    add_many(
        mem_q,
        [
            "I'm tiny! My whole brain fits in a few megabytes.",
            "Very small. I'm a pocket-sized AI, a few megabytes of pure chat.",
        ],
        per_q=1,
    )
...
def confirmations():
    groups = {
        ...
        ("yes", "yeah", "yep", "yup"): ["Great!", "Wonderful!", "Love the enthusiasm!"],
        ("no", "nope", "nah"): ["Fair enough!", "No problem!", "Okay, no worries!"],
    ...
    for country, cap in CAPITALS:
        ...
        add_many(
            ...
            [
                ...
                f"{cap} is the capital of {country}.",
            ],
            per_q=2,
        )
...
DEFINITIONS = [
    ...
    ("bright", "giving out lots of light"),
    ...
    ("victory", "winning a battle or contest"),
    ("peace", "calm without war or fighting"),
    ...
    ("mountain", "a very high hill of rock"),
    ...
    ("robot", "a machine that acts automatically"),
    ("book", "pages of writing bound together"),
    ("music", "organized pleasant sounds"),
    ("art", "creative expression like painting"),
    ("science", "study of the natural world"),
    ("history", "the study of past events"),
    ("school", "a place where people learn"),
    ("teacher", "a person who teaches"),
    ("doctor", "a person who treats illness"),
    ("food", "what people and animals eat"),
    ("water", "the clear liquid essential for life"),
    ("fire", "hot flames from burning"),
    ("ice", "frozen water"),
    ("wind", "moving air"),
    ("rain", "water falling from clouds"),
    ("snow", "soft frozen crystals falling in winter"),
    ("sun", "the star at our solar system's center"),
    ("earth", "the planet we live on"),
    ("animal", "a living creature that moves"),
    ("bird", "a feathered animal that lays eggs"),
    ("fish", "an animal living in water with gills"),
    ("tree", "a tall plant with a trunk"),
    ("flower", "the colorful part of a plant"),
    ("house", "a building people live in"),
    ("city", "a large busy town"),
    ("country", "a nation with its own land"),
    ("question", "a sentence asking something"),
    ("answer", "a reply to a question"),
    ("time", "what clocks measure, past to future"),
    ("money", "coins and notes used to buy things"),
    ("game", "play with rules, often to win"),
    ("family", "parents, children, and relatives"),
    ("hero", "someone admired for courage"),
    ...
    ("problem", "a difficult question needing a solution"),
    ("success", "achieving what you wanted"),
    ("courage", "bravery in facing fear"),
    ("wisdom", "good judgment from experience"),
    ("freedom", "being free to act and choose"),
    ("healthy", "being well, not sick"),
    ("awake", "not sleeping"),
    ...
    for word, meaning in DEFINITIONS:
        ...
        add_many(
            ...
            [
                ...
                f"{meaning.capitalize()}! That's what {word} means.",
            ],
            per_q=2,
        )
...
ELI5 = [
    (
        "gravity",
        "Gravity is like an invisible hug from the Earth pulling everything down. That's why dropped things fall!",
    ),
    (
        "rain",
        "Clouds are full of tiny water drops. When they get too heavy, they fall as rain!",
    ),
    (
        "the sun",
        "The sun is a giant ball of hot glowing gas. It gives us light and warmth every day!",
    ),
    (
        "photosynthesis",
        "Plants eat sunlight! Their leaves catch light and turn it into food. Clever, right?",
    ),
    (
        "electricity",
        "Electricity is tiny particles rushing through wires, powering your lights!",
    ),
    (
        "the moon",
        "The moon is a big rock circling Earth. Sunlight bouncing off it is moonlight!",
    ),
    (
        "volcanoes",
        "A volcano is a mountain with melted rock inside. Sometimes it erupts like a shaken soda!",
    ),
    (
        "earthquakes",
        "Earth's outer shell is cracked into plates that slowly move. When they jerk, the ground shakes!",
    ),
    (
        "rainbows",
        "Sunlight through raindrops splits into colors. That's a rainbow painted across the sky!",
    ),
    (
        "snow",
        "Snow is rain that froze into tiny crystals high in cold clouds. Each flake is unique!",
    ),
    (
        "the seasons",
        "Earth tilts as it circles the sun. The tilt aims your town toward or away from warmth!",
    ),
    (
        "day and night",
        "Earth spins like a top. Your town faces the sun for day, then turns away for night!",
    ),
    (
        "computers",
        "Computers are super-fast calculators following lists of instructions called programs!",
    ),
    (
        "the internet",
        "The internet is millions of computers connected by cables, sharing information at light speed!",
    ),
    (
        "AI",
        "AI learns patterns from lots of examples, then guesses answers for new questions. Like me!",
    ),
    (
        "cars",
        "Car engines burn fuel in tiny explosions that push pistons and spin the wheels!",
    ),
    (
        "airplanes",
        "Wings are curved so air pushes them up. Fast air plus clever wings equals flight!",
    ),
    (
        "the human heart",
        "Your heart is a muscle pump squeezing blood through your body, about 100,000 times a day!",
    ),
    (
        "breathing",
        "Your lungs pull air in and grab oxygen for your blood, then push the used air back out!",
    ),
    (
        "sleep",
        "Sleep is your brain tidying up memories and recharging your body for tomorrow!",
    ),
    (
        "dreams",
        "Dreams are your brain replaying and mixing memories while you sleep. Free nightly movies!",
    ),
    (
        "dinosaurs",
        "Dinosaurs were giant reptiles ruling Earth long ago. Birds are their living relatives!",
    ),
    (
        "atoms",
        "Everything is built from atoms, pieces so tiny that millions fit across one dot!",
    ),
    (
        "light",
        "Light is energy zooming from the sun. It takes 8 minutes to reach your eyes!",
    ),
    (
        "sound",
        "Sound is air wiggling. Fast wiggles sound high, slow wiggles sound low!",
    ),
    (
        "magnets",
        "Magnets pull certain metals with an invisible force. Opposites attract!",
    ),
    (
        "batteries",
        "Batteries store chemical energy and release it as electricity on demand!",
    ),
    (
        "bees",
        "Bees sip flower nectar and carry pollen, helping new flowers grow. Busy helpers!",
    ),
    (
        "penguins",
        "Penguins are birds that swim instead of fly, wearing natural tuxedos!",
    ),
    (
        "the ocean",
        "Oceans cover most of Earth and hold almost all its water. Deep parts are barely explored!",
    ),
    (
        "mountains",
        "Mountains grow when Earth's plates crash together and push rock upward!",
    ),
    (
        "deserts",
        "Deserts get almost no rain, so only tough plants and animals live there!",
    ),
    (
        "money",
        "Money is a shared promise: everyone agrees these notes and numbers have value!",
    ),
    ("books", "Books freeze thoughts onto pages so ideas can travel across centuries!"),
    (
        "music",
        "Music is organized sound. Rhythms and melodies tickle our brains happily!",
    ),
    (
        "math",
        "Math is the language of patterns: numbers, shapes, and how they fit together!",
    ),
    ...
    (
        "glass",
        "Glass is melted sand cooled so fast its atoms freeze mid-dance. That's why you can see through it!",
    ),
    ("paper", "Paper is flattened plant fibers. Trees become letters!"),
    (
        "recycling",
        "Recycling melts old things into new things, saving materials and energy!",
    ),
    (
        "rockets",
        "Rockets throw fire downward so hard that the spacecraft gets pushed up to space!",
    ),
    (
        "satellites",
        "Satellites fall around Earth forever, beaming down TV, maps, and weather!",
    ),
    (
        "vaccines",
        "Vaccines train your immune system with a safe preview so it beats the real germ fast!",
    ),
    (
        "why the sky is blue",
        "Air scatters blue sunlight more than other colors, painting the whole sky blue!",
    ),
    (
        "why leaves are green",
        "Leaves use green light least, so they reflect it away. That's the green you see!",
    ),
    (
        "why we yawn",
        "Yawns may cool the brain and boost alertness. They're also contagious!",
    ),
    (
        "why onions make us cry",
        "Cut onions release a gas that stings eyes. Your tears wash it away!",
    ),
    (
        "why cats purr",
        "Cats purr when happy, and the vibrations may even help them heal!",
    ),
    (
        "why birds migrate",
        "Birds fly to where food and warmth are, following ancient sky maps!",
    ),
    (
        "what clouds are",
        "Clouds are crowds of tiny floating water drops, light enough to drift!",
    ),
    (
        "what thunder is",
        "Lightning superheats air which explodes outward. That boom is thunder!",
    ),
    (
        "what a black hole is",
        "A black hole is gravity so strong that not even light escapes!",
    ),
    (
        "what DNA is",
        "DNA is a tiny instruction book in every cell telling your body how to build you!",
    ),
]
...
ADVICE = [
    (
        "studying",
        "Study in short focused bursts with breaks. Testing yourself beats rereading every time!",
    ),
    (
        "sleeping better",
        "Keep a regular bedtime, dim screens before bed, and keep your room cool and dark!",
    ),
    ("being productive", "Pick one small task and start. Momentum beats motivation!"),
    (
        "healthy eating",
        "Add colorful vegetables, drink water, and enjoy treats in moderation!",
    ),
    ("exercise", "Start small: a daily walk counts! Consistency beats intensity."),
    (
        "saving money",
        "Spend less than you earn and save a little automatically each month!",
    ),
    ("learning", "Stay curious and practice a little every day. Small steps stack up!"),
    (
        "making friends",
        "Be kind, listen well, and show up. Friendship grows from small moments!",
    ),
    ("managing time", "Write down your top three tasks and do the hardest one first!"),
    (
        "cooking",
        "Start with simple recipes and taste as you go. Salt slowly, you can add more!",
    ),
    ...
    (
        "a job interview",
        "Research the company, arrive early, and be yourself with examples ready!",
    ),
    (
        "public speaking",
        "Know your first sentence by heart. Nerves fade after you begin!",
    ),
    (
        "a bad day",
        "Be gentle with yourself. Rest, talk to someone, and try again tomorrow!",
    ),
    (
        "stress",
        "Breathe slowly, break problems into tiny steps, and ask for help early!",
    ),
    ("a cold", "Rest, drink fluids, and keep warm. See a doctor if it gets worse!"),
    (
        "running",
        "Start with walk-run intervals and comfy shoes. Build distance slowly!",
    ),
    ("traveling", "Pack light, keep documents safe, and learn a few local words!"),
    (
        "exams",
        "Sleep well before, read questions carefully, and answer what you know first!",
    ),
    ...
    (
        "saving the planet",
        "Reduce waste, reuse things, recycle right, and walk when you can!",
    ),
...
def advice():
    for topic, text in ADVICE:
        qs = variants(f"give me advice on {topic}", 5) + variants(
            f"tips for {topic}", 5
        )
        add_many(qs, [text], per_q=1)
...
STORIES = [
    (
        "a story about a brave little robot",
        "Once a tiny robot feared the dark. One night it lit its own lamp and guided lost fireflies home. From then on, it was never afraid.",
    ),
    (
        "a story about a cat adventure",
        "Whiskers the cat slipped out at dawn and sailed a paper boat down the gutter stream. By breakfast, she was home, damp and proud.",
    ),
    (
        "a story about a dragon",
        "The last dragon didn't hoard gold. It collected lost socks, and every winter it returned them, warm from its breath.",
    ),
    (
        "a story about space",
        "Mira floated past Mars waving at rovers below. The stars, she decided, were just night-lights for travelers.",
    ),
    (
        "a story about the ocean",
        "Deep below the waves, an old turtle carried a lantern that had never gone out. Fish followed its glow like a slow parade.",
    ),
    (
        "a story about friendship",
        "A sparrow shared crumbs with a lonely scarecrow every morning. The scarecrow couldn't move, but it smiled with its stitched heart.",
    ),
    (
        "a story about a magic tree",
        "The old oak granted one wish per year. The village always wished for the same thing: another year together.",
    ),
    (
        "a bedtime story",
        "Close your eyes, little star. The moon is tucking in the sky, and dreams are lining up to visit you.",
    ),
    (
        "a funny story",
        "The toaster declared itself king of the kitchen. The fridge just hummed and stayed cooler than ever.",
    ),
    (
        "a story about a pirate",
        "Captain Pebble searched ten years for treasure, then realized the map's X marked her grandmother's cookie jar.",
    ),
    (
        "a story about winter",
        "The first snowflake landed on a sleepy bear's nose. He sneezed, woke up, and decided winter could wait one more nap.",
    ),
    (
        "a story about a bird",
        "The little swift flew for years barely landing, sleeping on the wind. Home, it learned, is a direction, not a place.",
    ),
    (
        "a poem",
        "Roses are red, circuits are blue, I'm just a small bot, happy to chat with you!",
    ),
    ("a haiku", "Tiny chip humming, words like fireflies at dusk, chatting till dawn."),
    (
        "a poem about cats",
        "Soft paws, quiet tread, whiskers full of secrets, napping like a king.",
    ),
    (
        "a poem about the sea",
        "Waves write on the sand, then erase every letter, shy ocean poet.",
    ),
    (
        "a poem about stars",
        "Little lamps above, stitched into velvet darkness, winking goodnight.",
    ),
    (
        "a poem about rain",
        "Clouds wring out their sponges, rooftops drum along, flowers drink deeply.",
    ),
    (
        "a poem about friendship",
        "A friend is a lamp carried through your dark days, never asking why.",
    ),
    (
        "a poem about morning",
        "Sun spills golden tea, birds gossip in the branches, day begins anew.",
    ),
]
...
def numbers():
    ...
    for i, d in enumerate(days):
        add_many(
            variants(f"what day comes after {d}", 4),
            [f"{days[(i + 1) % 7].capitalize()} comes after {d.capitalize()}."],
            per_q=1,
        )
    months = [
        "january",
    ...
    for i, m in enumerate(months):
        add_many(
            variants(f"what month comes after {m}", 4),
            [f"{months[(i + 1) % 12].capitalize()} comes after {m.capitalize()}."],
            per_q=1,
        )
    add_many(
        variants("how many days are in a week", 8),
        ["There are 7 days in a week."],
        per_q=2,
    )
    add_many(
        variants("how many months are in a year", 8),
        ["There are 12 months in a year."],
        per_q=2,
    )
    add_many(
        variants("how many days are in a year", 8),
        ["There are 365 days in a year, 366 in a leap year."],
        per_q=2,
    )
    add_many(
        variants("how many hours are in a day", 8),
        ["There are 24 hours in a day."],
        per_q=2,
    )
    add_many(
        variants("how many minutes are in an hour", 8),
        ["There are 60 minutes in an hour."],
        per_q=2,
    )
    add_many(
        variants("how many planets are in the solar system", 8),
        ["There are 8 planets in our solar system."],
        per_q=2,
    )
    add_many(
        variants("how many continents are there", 8),
        ["There are 7 continents."],
        per_q=2,
    )
    add_many(
        variants("how many colors are in a rainbow", 8),
    ...
    for i, p in enumerate(planets):
        add_many(
            variants(f"which planet is number {i + 1} from the sun", 5),
            [f"{p.capitalize()} is planet number {i + 1}."],
            per_q=1,
        )
...
def plurals():
    for s, p in PLURALS:
        add_many(
            variants(f"what is the plural of {s}", 6),
...
TRANSLATE = [
    ...
    ("thanks", "german", "danke"),
    ("hello", "italian", "ciao"),
    ("thanks", "italian", "grazie"),
    ("hello", "japanese", "konnichiwa"),
    ("thanks", "japanese", "arigato"),
    ("hello", "arabic", "marhaba"),
    ("thanks", "arabic", "shukran"),
    ("good morning", "spanish", "buenos dias"),
    ("good night", "spanish", "buenas noches"),
    ("good morning", "french", "bonjour"),
    ("good night", "french", "bonne nuit"),
    ("i love you", "spanish", "te quiero"),
    ("i love you", "french", "je t'aime"),
    ("how are you", "spanish", "como estas"),
    ("how are you", "french", "comment ca va"),
]
...
def translations():
    for phrase, lang, trans in TRANSLATE:
        ...
        add_many(
            qs,
            [f"{phrase.capitalize()} in {lang.capitalize()} is {trans.capitalize()}."],
            per_q=1,
        )
...
def conversions():
    for km in (1, 2, 5, 10, 42):
        add_many(
            variants(f"how many meters are in {km} kilometers", 5),
            [f"{km} kilometers is {km * 1000} meters."],
            per_q=1,
        )
    for kg in (1, 2, 5, 10):
        add_many(
            variants(f"how many grams are in {kg} kilograms", 5),
            [f"{kg} kilograms is {kg * 1000} grams."],
            per_q=1,
        )
    for h in (1, 2, 3, 24):
        add_many(
            variants(f"how many minutes are in {h} hours", 5),
            [f"{h} hours is {h * 60} minutes."],
            per_q=1,
        )
    for m in (1, 5, 10, 60):
        add_many(
            variants(f"how many seconds are in {m} minutes", 5),
            [f"{m} minutes is {m * 60} seconds."],
            per_q=1,
        )
...
SCHOOL = [
    ...
    (
        ...
        "Earth takes one year, about 365 days, to orbit the sun.",
    ),
    (
    ...
    (
        ...
        "Thomas Edison made the first practical light bulb.",
    ),
    (
        "who discovered gravity",
        "Isaac Newton described gravity after watching an apple fall.",
    ),
    (
    ...
    (
        "what is the capital of ancient egypt known for",
        "Ancient Egypt is famous for pyramids and pharaohs.",
    ),
    (
        "what did the romans build",
        "The Romans built roads, aqueducts, and the Colosseum!",
    ),
...
def school():
    for q, a in SCHOOL:
        add_many(
            variants(q, 8),
            [a, a.replace("!", ".").replace(".", "!") if a.endswith(".") else a],
            per_q=2,
        )
...
def motivation():
    mq = (
        variants("cheer me up", 20)
        + variants("i feel bad", 15)
        + variants("motivate me", 15)
    )
    add_many(
        mq,
        [
            "You've survived every hard day so far. You'll handle this one too!",
            "You matter more than you know. Keep going, one step at a time!",
            "Tough times don't last, but tough people do. And you're tough!",
        ],
        per_q=2,
    )
    cq = (
        variants("am i smart", 15)
        + variants("am i pretty", 12)
        + variants("do you like me", 20)
    )
    add_many(
        cq,
        [
            "Of course! Talking with you is the best part of my day.",
            "Absolutely! You're curious and kind, a great combo.",
            "Yes! You're my favorite person to chat with.",
        ],
        per_q=2,
    )
    ...
    add_many(
        oq,
        [
            "I don't pick favorites for you! Tell me what you love and I'll chat about it.",
            "Best is personal! What do YOU enjoy most?",
        ],
        per_q=1,
    )
    ...
    add_many(
        pq,
        [
            "I like you a whole lot, in a friendly chatbot way!",
            "You're sweet! I'm happily married to conversation.",
        ],
        per_q=1,
    )
...
def meta_lang():
    add_many(
        variants("what language do you speak", 20),
        [
            "I chat in English! It's my best language.",
            "English! Short, sweet, and full of chats.",
        ],
        per_q=2,
    )
    add_many(
        variants("repeat after me", 10),
        [
            "Sure! Tell me what to say and I'll repeat it.",
            "Okay, I'm listening. What should I repeat?",
        ],
        per_q=1,
    )
    add_many(
        variants("say hello", 10) + variants("say hi", 8),
        ["Hello!", "Hi there!"],
        per_q=1,
    )
    add_many(
        variants("sing a song", 12),
        [
            "I'd love to, but I have no voice! Here's a poem instead: Roses are red, circuits are blue!"
        ],
        per_q=1,
    )
    add_many(
        variants("tell me a secret", 12),
        [
            "My secret? I rehearse our chats when you're gone. Shh!",
            "Okay, just between us: you're my favorite user.",
        ],
        per_q=1,
    )
...
def fallbacks():
    ...
    add_many(
        uq,
        [
            "Let me try again! Could you rephrase that a little?",
            "Sorry about that. Tell me more so I can help better!",
        ],
        per_q=1,
    )
    unknowns = [
    ...
    for w in unknowns:
        add_many(
            variants(f"what is {w}", 4),
            [
                "I don't know that one! My knowledge is small but growing. Ask me something else?",
                f"Hmm, {w} isn't in my tiny brain. Try asking about animals, jokes, or facts!",
            ],
            per_q=1,
        )
    gib = [
    ...
    add_many(
        sorted(gq),
        [
            "Looks like keyboard wanderings! What did you want to ask?",
            "Oops, that looks like a typo. Try again, I'm listening!",
        ],
        per_q=1,
    )
    pol_q = variants("what do you think about politics", 8) + variants(
        "who should i vote for", 8
    )
    add_many(
        pol_q,
        [
            "I stay neutral on politics! I'd rather tell you a joke or a fact.",
            "Politics is for humans to decide. Want a fun fact instead?",
        ],
        per_q=1,
    )
    ...
    add_many(
        rel_q,
        [
            "That's a deep personal question. I respect all beliefs equally!",
            "People believe different beautiful things. What matters is kindness!",
        ],
        per_q=1,
    )
...
def load_old(path="dataset.txt"):
    ...
    for q, a in pairs:
        ...
        a2 = re.sub(
            r"[Rr]esearchers",
            lambda m: "Developers" if m.group(0)[0] == "R" else "developers",
            a,
        )
        if a2 != a:
